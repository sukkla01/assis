                   ...
                   <table class="table">
                    ...
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
                             $result_color = $row['t1'] == 'รอผล' ? '#FD6D48' : '#1FA363';
                            ?>
                            <tr>
                                ...
                                <td style="font-size: 20px;text-align: right"><span style="background-color: <?=$result_color?>;border-radius: 10px;color: white;font-size: 16px;font-weight: normal">&nbsp; <?=$row['t1']; ?> &nbsp;</span></td>
